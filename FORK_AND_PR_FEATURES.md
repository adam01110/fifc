...
| --- | --- | --- | --- | --- |
| `adam01110/fifc` | 8 | `#49`, `#52`, `#54`, `#60` | `#61` equivalent via `#49` behavior; also includes the fork-only binding persistence fix, path-with-spaces display fix, apostrophe-safe completion fix, and incomplete-path file completion fix | `#36` |
...
- `adam01110/fifc` now carries exact PR `#49`, `#52`, `#54`, and `#60` behavior in one fork, plus the fork-only binding-persistence, path-with-spaces display, apostrophe-safe completion, and incomplete-path file completion fixes.
